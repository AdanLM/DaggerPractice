...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private boolean isValidDestination(int destinationId) {
        return destinationId != Navigation.findNavController(this, R.id.nav_host_fragment).getCurrentDestination().getId();
    }
